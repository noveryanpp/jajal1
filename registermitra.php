                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                          <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form action='proses_reg_mitra.php' method='post'>
                              ...
                              <div class="form-outline mb-4">
                                <input type="text" name="nis/nisn" class="form-control form-control-lg" />
                                <label class="form-label" for="nis/nisn">NIS/NISN</label>
                              </div>

                              <div class="form-outline mb-4">
                                <input type="file" name="sertifikasi" class="form-control form-control-lg" />
                              ...
                              <div class="form-outline mb-4">
                                ...
                                <label class="form-label" for="seritifikasi">Foto Profil</label>
                              </div>
                              ...
                              <div class="pt-1 mb-4">
                              <input type="submit" name="registermitra" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" value="Daftar"/>
                              </div>
                            </form>
                          </div>
                        </div>
