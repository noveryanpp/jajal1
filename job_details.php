                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                          ...
                          <ul>
                              <li>Diunggah Pada : <span>12 Aug 2023</span></li>
                              <li>Lokasi : <span>Yogyakarta</span></li>
                              <li>Harga :  <span>Rp50.0000 - Rp1.000.000</span></li>
                          </ul>
                        ...
                        <div class="post-details4  mb-50">
                           ...
                           <div class="small-section-tittle">
                              ...
                              <span>Samsul Arif</span>
                              <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                            <ul>
                                <li>Nama : <span>Samsul Arif</span></li>
                                <li>Web : <span>samsularif.com</span></li>
                                <li>Email : <span>samsularif@gmail.com</span></li>
                                <li>No. Telp : <span>+62123948910249</span></li>
                            </ul>
                       </div>
                    </div>
                </div>
